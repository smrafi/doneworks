...
class tz_video_widget extends WP_Widget {
	...
	function TZ_Video_Widget() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'tz_video_widget', 'description' => __('A widget that displays your YouTube or Vimeo Video.', 'framework') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'tz_video_widget' );
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => 'My Video',
		'embed' => stripslashes( '<object type="application/x-shockwave-flash" style="width:290px; height:243px;" data="http://vimeo.com/moogaloop.swf?clip_id=2285902&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1">
<param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=2285902&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1" />
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'embed' ); ?>"><?php _e('Embed Code (Best at 290px wide)', 'framework') ?></label>
