...
$numrows = count($this->condition_list);
?>
...
<form action="index.php" method="post" name="adminForm">
    ...
    <table class="adminlist">
		...
		<th width="20"><input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo $numrows; ?>);" /></th>
                ...
                <th class="title" nowrap="nowrap"><?php echo JText::_('COM_TELLMEMD_CONDITION_NAME'); ?></th>
        ...
        <tbody>
            ...
            for($x = 0; $x < $numrows; $x++)
            {
                $row = $this->condition_list[$x];
                $checked = JHtml::_('grid.id', $x, $row->id);
                $link = JRoute::_(COMPONENT_LINK.'&controller=conditions&task=edit&cid[]='.$row->id);
            ...
            <tr class="<?php echo 'row'.$k; ?>">
                ...
                <td>
                    <?php echo JHtml::link($link, $row->condition_name); ?>
                </td>
                <td>
