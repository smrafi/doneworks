...
<h1>Application Data Review - Accounts Head</h1>
...
<div class="comp-content">
    <form class="submit-form" action="index.php" method="post" name="adminForm">
        ...
        <div id="grant-input">
            <div id="amount-input">
                <span>Accounts Head (PF)</span><br/><br/>
                A grant of Rs. <input type="text" name="account_grant" id="account_grant" value="" /> may be considered pl.
            </div>
            <div id="note-input">
                <span>Comment:</span><br/>
                <textarea cols="30" rows="5" name="account_comment" id="account_comment"></textarea>
            </div>
        </div>
    </form>
</div>