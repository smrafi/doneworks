...
<h1>Applications to Review Secretary of President Fund</h1>
<div class="comp-button">
   <button type="button" name="spback_btn" class="spback_btn" onclick="routeback('prsec', 'linkback');">Back</button>
</div>
        ...
        <table class="adminlist">
            ...
            <tbody>
                ...
                for($x = 0; $x < $numrows; $x++)
                {
                    ...
                    $link = JRoute::_(COMPONENT_LINK.'&controller=prsec&task=viewapp&cid='.$row->id);
