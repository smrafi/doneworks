...
<h1>Make Health Ministry Response<?php echo '&nbsp;&nbsp;&nbsp;'.$pnum; ?></h1>
...
<div class="comp-content">
    <form class="submit-form" action="index.php" method="post" name="adminForm" enctype="multipart/form-data">
        ...
        <input type="hidden" name="controller" value="healthmin" />
        ...
        <table>
            <tr>
                <td>
                    <?php echo JText::_('Health Ministry Reply File').':'; ?>
                </td>
                <td>
                    <input type="file" name="hmresponse_file" id="hmresponse_file" />
                </td>
            </tr>
            <tr>
                <td>
                    <?php echo JText::_('Health Ministry Response Note').':'; ?>
                </td>
                <td>
                    <textarea cols="30" rows="5" name="healthministry_note" id="healthministry_note"></textarea>
                </td>
            </tr>
        </table>
    </form>
