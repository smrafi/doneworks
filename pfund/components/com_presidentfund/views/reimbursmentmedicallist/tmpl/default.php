...
$search_by = array(0 => 'Select', 
                     SEARCH_BY_DISEASE_CANCER => 'Cancer Patients',
                     SEARCH_BY_DISEASE_KIDNEY => 'Kidney Patients',
                     SEARCH_BY_AMOUNT_LESS_LAKH => 'Amount Less Then 100,000');
...
?>
<h1>Reimbursement Medical Payment</h1>
<div class="comp-button">
    <button type="button" name="medical_voucher_btn" class="medical_voucher_btn" >Release voucher</button>
    <button type="button" name="medical_released_btn" class="medical_released_btn" >Release Payment</button>
...
<form action="index.php" method="post" name="adminForm" class="submit-form"  enctype="multipart/form-data">
    ...
    <input type="hidden" name="type" value="<?php echo APPLICATION_TYPE_REIMBURSMENT;?>" />
   ...
   <?php echo $tabs->startPanel(JText::_('Voucher Released List'),"released-voucher"); ?>
		...
		<td>
                ...
                <td>
                 ...
                 <td>
                     <a href=<?php echo COMPONENT_LINK.'&controller=medicalpayment&task=uploadreceipt&cid='.$row_released->application_id.'&type='.APPLICATION_TYPE_REIMBURSMENT; ?>><button type="button" name="upload_btn"  >Upload Receipt</button></a>
		</td>
...
<?php echo $tabs->startPanel(JText::_('Receipt Uploaded List'),"Receipt-Uploaded"); ?>
		...
		<tr>
				...
				<?php echo '#'; ?>
                        ...
                        <th width="5%">
				<input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo $numreceipt; ?>);" />
			</th>
			<th class="title" nowrap="nowrap">
				<?php echo JText::_( 'Full Name' ); ?>
			</th>
