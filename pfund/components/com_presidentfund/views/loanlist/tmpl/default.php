    	...
    	<tr class="<?php echo 'row'.$k; ?>">
			...
			<td align="center">
				...
				<?php  echo  $row->al_rate; ?>
                        ...
                        <td>
                             <a class="modal"  rel="{handler: 'iframe', size: {x: 800, y: 450}}" href=<?php echo JURI::root().'components/com_presidentfund/files/letters/loan/request/'.$row->al_request;  ?> >View</a>
				
			</td>
                        <td>
                              <a class="modal"  rel="{handler: 'iframe', size: {x: 800, y: 450}}" href=<?php echo JURI::root().'components/com_presidentfund/files/letters/loan/offer/'.$row->al_offer;  ?> >View</a>
