...
<h1>Letters Generated to Health Ministry</h1>
    ...
    <form class="submit-form" action="index.php" method="post" name="adminForm">
        ...
        <table class="adminlist">
            ...
            <tbody>
                ...
                for($x = 0; $x < $numrows; $x++)
                {
                    $row = $this->list_data[$x];
                    $viewlink = JRoute::_(COMPONENT_LINK.'&controller=special&task=viewletterlist&record_id='.$row->id);
                    $print_link = JRoute::_(COMPONENT_LINK.'&controller=special&task=printhmletter&record_id='.$row->id.'&tmpl=component');
                ...
                <tr class="<?php echo 'row'.$k; ?>">
                    ...
                    <td>
                        ...
                        <a class="modal"  rel="{handler: 'iframe', size: {x: 800, y: 500}}" href="<?php echo $print_link;  ?>"><button name="printbtn" id="printbtn" type="button">Print</button></a>
                    </td>
                </tr>
                <?php
                $k = 1 - $k;
