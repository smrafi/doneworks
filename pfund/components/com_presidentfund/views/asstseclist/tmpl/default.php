...
<div class="comp-button">
   <button type="button" name="spback_btn" class="spback_btn" onclick="routeback('asstsec', 'backop');">Back</button>
</div>
        ...
        <table class="adminlist">
            ...
            <tbody>
                ...
                for($x = 0; $x < $numrows; $x++)
                {
                    ...
                    $link = JRoute::_(COMPONENT_LINK.'&controller=asstsec&task=viewapp&cid='.$row->id);
