...
<form  action="index.php" method="post" name="adminForm" enctype="multipart/form-data">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <textarea name="patient_address" id="patient_address" cols="40" rows="5"><?php echo $this->application_data->patient_address; ?></textarea>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <textarea name="patient_empaddress" id="patient_empaddress" cols="40" rows="5"><?php echo $this->application_data->patient_empaddress; ?></textarea>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <textarea name="applicant_address" id="applicant_address" cols="40" rows="5"><?php echo $this->application_data->applicant_address; ?></textarea>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <textarea name="applicant_empaddress" id="applicant_empaddress" cols="40" rows="5"><?php echo $this->application_data->applicant_empaddress; ?></textarea>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" id="income-table">
        ...
        <tbody>
            <tr>
                <td>
                    <input name="income_data[member_name][]" value="" size="30" />
                </td>
                <td>
                    <?php echo PFundHelper::createList('income_data[member_marriage][]', 0, $marriage_status); ?>
                </td>
                <td>
                    <input name="income_data[member_occupation][]" value="" size="30" />
                </td>
                <td>
                    <input name="income_data[member_income][]" value="" size="30" />
                </td>
                <td>
                    <?php echo PFundHelper::createList('income_data[paying_tax][]', 0, $logic_array); ?>
                </td>
                <td>
                    <input name="income_data[tax_file][]" value="" size="30" />
                </td>
            </tr>
        </tbody>
    </table>
